        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title m-0">{{ __('admin.addWrapping') }}</h4>
                </div>
                <div class="card-body">
                    <form class="needs-validation" action="{{ route('Wrapping.store') }}" method="POST"
                        ...
                        <button class="btn btn-primary" type="submit">{{ __('admin.addWrapping') }}</button>
                    </form>
                </div>
            </div>
            <!-- end card -->
