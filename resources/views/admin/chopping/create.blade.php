        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title m-0">{{ __('admin.addChopping') }}</h4>
                </div>
                <div class="card-body">
                    <form class="needs-validation" action="{{ route('Chopping.store') }}" method="POST"
                        ...
                        <button class="btn btn-primary" type="submit">{{ __('admin.addChopping') }}</button>
                    </form>
                </div>
            </div>
            <!-- end card -->
