                    ...
                    <table id="datatable" class="table table-bordered dt-responsive text-nowrap w-100">
                        ...
                        <tbody>
                            <tr data-id="1">
                                ...
                                <td class="align-middle" style="white-space: normal;">{!! mb_strimwidth($about->value(), 0, 50000000000, ',...') !!}</td>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                    <h5 class="modal-title">{{ __('admin.edit_about') }}</h5>
                    <button aria-label="Close" class="close" data-dismiss="modal" type="button"><span
                            aria-hidden="true">&times;</span></button>
                </div>
                <div class="modal-body">
                    <form id="acceptForm" class="d-inline" action="{{ route('about.update') }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('value_ar') is-invalid @enderror" id="description" name="value_ar" required>{{ $about->value_ar }}</textarea>
                                    @error('value_ar')
                            ...
                            <div class="col-lg-12">
                                <div class="mb-3">
                                    <label for="value_en" class="form-label">{{ __('admin.desc_en') }}<span
                                            class="text-danger fw-bolder">*</span></label>
                                    <textarea class="form-control @error('value_en') is-invalid @enderror" id="description_en" name="value_en" required>{{ $about->value_en }}</textarea>
                                    @error('value_en')
                                        <span class="invalid-feedback" role="alert">
