...
<head>
    ...
    <title>وضع الصيانه</title>

    <!-- Favicon -->
    <link rel="shortcut icon" href="{{ $setting ? $setting->logo : asset('uploads/defaults/logo.jpg') }}" />
    ...
    <div class="wrapper">
        <div class="gradient">
            <div class="container">
                ...
                <h2 class="mb-0 mt-4 text-white">وضع الصيانة</h2>
                <p class="mt-2 text-white">{{ $MentanecMode ? $MentanecMode->value : 'الموقع مغلق للصيانة' }}
                </p>
